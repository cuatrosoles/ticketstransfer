...
const registerBase = z.object({
    ...
    latitude: z.preprocess((v) => (v === '' || v == null || v === undefined ? undefined : Number(v)), latitudeSchema.optional()),
    longitude: z.preprocess((v) => (v === '' || v == null || v === undefined ? undefined : Number(v)), longitudeSchema.optional()),
...
export const createTicketListingSchema = z.object({
    ...
    eventLatitude: z.preprocess((v) => (v === '' || v == null || v === undefined ? undefined : Number(v)), latitudeSchema.optional()),
    eventLongitude: z.preprocess((v) => (v === '' || v == null || v === undefined ? undefined : Number(v)), longitudeSchema.optional()),
...
export { NOTIFICATION_PREFERENCE_KEYS, NOTIFICATION_PREFERENCE_LABELS, DEFAULT_NOTIFICATION_PREFERENCES, mergeNotificationPreferences, allowsPushType, pushTypeToPreferenceKey, } from './notification-preferences.js';
