...
export const TICKETERAS_IDS = ['TICKETEK', 'ALLACCESS', 'TICKETERA', 'TICKET_PLUS', 'OTRA'] as const;
...
export const APPS_BOLETOS_IDS = ['QUENTRO', 'ENIGMA', 'TICKET360', 'TICKETMAKER', 'OTRA'] as const;

/** Acción del usuario: VENTA | INTERCAMBIO */
export const ACCION_FLUJO = ['VENTA', 'INTERCAMBIO'] as const;

export const CATEGORIAS_EVENTOS = ['MUSICA', 'DEPORTES', 'TEATRO', 'FESTIVALES', 'OTRO'] as const;
export const TIPO_ENTRADA = ['GENERAL', 'CAMPO', 'PLATEA', 'VIP', 'OTRO'] as const;
...
export const KYC_STATUS = ['PENDIENTE', 'EN_REVISION', 'APROBADO', 'RECHAZADO'] as const;
